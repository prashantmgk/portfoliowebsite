      ...
      <div className='flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start'>
        <div>
          <div className="flex gap-5 mb-6 mt-12 md:mt-0">
            ...
            <a href="https://github.com/prashantmgk/" 
              style={{ width: '30px', background: 'transparent' }} 
              target="_blank" 
              rel="noopener noreferrer"
              className="bw-on-hover">
            ...
            <a href="https://x.com/prashantmgk/" 
              style={{ width: '30px', background: 'transparent' }} 
              target="_blank" 
              rel="noopener noreferrer"
              className="bw-on-hover">
          ...
          <h1 class="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 flex flex-col gap-3 items-center lg:items-start"><span class="relative ">Prashant Man Gayak,</span><span class="whitespace-nowrap relative "><span class=" relative whitespace-nowrap"><span class="absolute bg-neutral-content -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1"></span><span class="relative text-neutral text-opacity-0 bg-transparent">Web</span></span><span class="mr-3 sm:mr-4 md:mr-5 ml-4">developer</span></span></h1>
        </div>
        <p className='text-lg lg:text-xl text-neutral-content my-5 md:my-0'>I bring websites to life as a front-end developer. I translate designs into user-friendly interfaces. My focus is on creating intuitive web experiences.</p>
        <div class="space-y-4">
          <a href={CV} download="CV of Prashant Man Gayak.pdf" className="btn btn-primary group btn-wide bw-on-hover my-5 md:my-0" title="Download My CV"><img src={DirectDonwloadIcon} alt="Download CV" style={{ width: '20px', background: 'transparent' }} /> Download CV</a>
